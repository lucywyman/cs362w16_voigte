...
int councilRoomCard(struct gameState *state,
                    int currentPlayer,
                    int handPos)
{
    int i;
...
int feastCard(struct gameState *state,
              int currentPlayer,
              int choice1)
{
    int i, x;
...
int mineCard(struct gameState *state,
             int currentPlayer,
             int handPos,
             int choice1,
             int choice2)
...
int remodelCard(struct gameState *state,
                int currentPlayer,
                int handPos,
                int choice1,
                int choice2)
